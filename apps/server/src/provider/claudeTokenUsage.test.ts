...
describe("Claude token arithmetic", () => {
  ...
  it.each([
    {
      ...
      expected: {
        ...
        inputTokens: 23_863,
        cacheReadInputTokens: 21_144,
        lastCacheReadInputTokens: 21_144,
        cacheWriteInputTokens: 2_715,
        lastCacheWriteInputTokens: 2_715,
        outputTokens: 679,
        maxTokens: 200_000,
      },
    },
  ...
  it("normalizes the SDK live context response and prefers its auto-compact threshold", () => {
    ...
    expect(snapshotFromClaudeContextUsage(usage, 535_000)).toEqual({
      ...
      cacheReadInputTokens: 105_000,
      cacheWriteInputTokens: 5_000,
      lastCachedInputTokens: 105_000,
      lastCacheReadInputTokens: 105_000,
      lastCacheWriteInputTokens: 5_000,
      outputTokens: 2_000,
