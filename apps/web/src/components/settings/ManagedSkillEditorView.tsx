...
export function ManagedSkillEditorView({
  ...
  return (
    <form className="[&>.settings-group]:mt-4!" onSubmit={(event) => void handleSubmit(event)}>
      ...
      >
        <SettingsCard divided={false} className="managed-skill-editor-fields space-y-5 pt-4">
