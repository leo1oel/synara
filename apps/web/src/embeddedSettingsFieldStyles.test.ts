...
const EMBEDDED_SETTINGS_CONTROL_LAYOUT_CSS = INDEX_CSS.slice(CONTROL_LAYOUT_BLOCK_START, CONTROL_LAYOUT_BLOCK_END);
...
describe("embedded Settings field styles", () => {
  ...
  it("reserves the fixed trailing column for form controls without stretching list actions", () => {
    ...
    expect(EMBEDDED_SETTINGS_CONTROL_LAYOUT_CSS).toContain("width: var(--lattice-settings-control-width)");
  ...
  it("uses one typography contract for buttons, fields, and dropdown options", () => {
    ...
    expect(EMBEDDED_SETTINGS_TYPOGRAPHY_CSS).toContain("font-size: var(--lattice-settings-control-font-size)");
    expect(EMBEDDED_SETTINGS_TYPOGRAPHY_CSS).toContain("font-weight: var(--lattice-settings-control-font-weight)");
    ...
    expect(EMBEDDED_SETTINGS_POPUP_CSS).toContain("font-size: var(--lattice-settings-control-font-size)");
    expect(EMBEDDED_SETTINGS_POPUP_CSS).toContain("line-height: var(--lattice-settings-control-line-height)");
    expect(EMBEDDED_SETTINGS_POPUP_CSS).toContain("font-weight: var(--lattice-settings-control-font-weight)");
  });
});
